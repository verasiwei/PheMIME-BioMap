...
enrichment_datt = readRDS("data/enrichment_datt.rds")
shared_phe = readRDS("data/shared_phe_biomolecule_pvalue_cox.rds") %>% filter(!is.na(p_value)) %>% arrange(p_value)
shared_phe$sel_phenotype = str_replace_all(shared_phe$sel_phenotype,", ","_")
shared_phe$co_phenotype = str_replace_all(shared_phe$co_phenotype,", ","_")
